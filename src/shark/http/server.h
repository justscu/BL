...
class Server {
public:
	Server(const int threads_num, const std::string &name, const std::string &ver)
...
private:
	// http 头部
	void http_header(evhtp_request_t *req, const std::string &mime, const std::string &charset="utf-8");
