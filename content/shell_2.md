...
将ios文件做个软链接到`/mnt/ios`, `ln -s /home/ll/software/iso/rhel-server-7.2-x86_64-dvd.iso /mnt/iso`

将`/mnt/ios`下的iso文件，挂载到`/mnt/cdrom`, `mount -o loop /mnt/ios/rhel-server-7.2-x86_64-dvd.iso /mnt/cdrom`, 使用`df -h`命令，查看是否挂载成功
